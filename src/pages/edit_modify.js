    ...
    <>
      <Layout>
        <main className="p-6 space-y-6">
          ...
          >
          <div onClick={handleGoBack} className="btn" style={{padding:"7px 15px",background: "#074465", margin: "10px 10px 0px 15px", fontSize: "16px",color: "#fff"}}>Back </div>
